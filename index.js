...
const mailMessage = (url) => {
  return `<p>Hello,<br/> <br/>  You have a secret message from anonymous waiting for you to open.<br /> <a href=${url} target='_blank'>${url}</a><br /> Thank you and don't share it to anyone!!! </p>`;
};
...
router.post("/create-message", async (req, res) => {
  try {
    ...
    const data = {
      ...
      targetMail: req.body.targetMail
    };
